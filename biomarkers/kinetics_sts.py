'''
    ---------------------------------------------------------------------------
    OpenCap processing: kinetics_sts.py
    ---------------------------------------------------------------------------
    Copyright 2022 Stanford University and the Authors
    
    Author(s): Antoine Falisse, Scott Uhlrich
    Modified by Catherine
    Adapted from example: example_kinetics.py
...
session_id = "51c3b079-a9f4-4c41-b499-84e304e3afc7"
case = '0' # Change this to compare across settings.
# Options are 'squat', 'sitstand', and 'jump'.
if session_type == 'overground': 
    trial_name = 'sitstand'
    if trial_name == 'squat': # Squat
        motion_type = 'squats'
        repetition = 1
    elif trial_name == 'sitstand': # Sit-to-stand        
